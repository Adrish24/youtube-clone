...
const SearchResult = () => {
  ...
  useEffect(() => {
    const resultElement = searchResultRef.current;

    if (resultElement) {
      if (windowWidth < 1280) {
        resultElement.classList.remove("xl:ml-60");
        return;
      }

      if (windowWidth >= 1280 && isSidebarOpen) {
        resultElement.classList.add("xl:ml-60");
        return;
      }
    }
  ...
  if (!results || results.length === 0)
    return (
      <div className="flex px-2  md:ml-20 h-full">
        <div className="m-auto flex flex-col items-center w-md space-y-2">
          <svg
            viewBox="0 0 230 130"
          ...
          >
            ...
            <path
              ...
              d="M3.43 126.34H227a29.17 29.17 0 0 0-5.06-24c-4.42-6.11-10-12.51-9.71-28.73s-.4-59.23-20.9-67.3c-28.87-11.37-53.18 18.05-71.57 19s-32.31-9.34-45.87-4.5-11.63 16.68-18.17 19.83-20.58.73-25.18 13.8S34.06 77.8 25 83.73c-8.82 5.75-27.62 9.32-21.57 42.61z"
            ></path>
            <g clip-path="url(#clip-path_yt13)">
              <path
                fill="#ffd61d"
          ...
          <h2 className="text-2xl font-semibold mt-5">No results found</h2>
          ...
          results.map((video) => (
            <Card
              ...
              styles={{
                ...
                card: "flex flex-row space-x-4",
                thumbnailContainer: "flex-1/2 flex lg:w-44 lg:pr-2 ",
                thumbnail: "w-full h-full aspect-video object-cover rounded-xl",
                cardBody: "flex-1/2 w-full lg:w-lg xl:w-xl flex",
                profile: "hidden",
