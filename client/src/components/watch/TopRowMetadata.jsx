...
const TopRowMetadata = ({ currentVideo }) => {
  ...
  return (
    <div className="flex flex-wrap lg:flex-nowrap">
      ...
      <div className="grow flex flex-wrap gap-1 lg:flex-nowrap items-center-safe  mt-3 mr-3">
      ...
      <div className="grow flex items-center md:justify-end  p-1 -m-1 space-x-2 relative top-1">
